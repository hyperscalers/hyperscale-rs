...
pub const SPARSE_MERKLE_PLACEHOLDER_HASH: Hash = Hash::ZERO;
...
#[derive(Clone, Copy, Debug, Hash, Eq, PartialEq, Ord, PartialOrd, BasicSbor)]
#[sbor(transparent)]
...
// Custom SBOR impls for NibblePath (kept generic over CustomValueKind)
