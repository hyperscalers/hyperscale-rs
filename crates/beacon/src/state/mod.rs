...
mod tests {
    ...
    use hyperscale_types::{
        BeaconProposal, BeaconState, Bls12381G1PrivateKey, Bls12381G1PublicKey, Epoch, JailReason,
        LeafIndex, NetworkDefinition, PendingWithdrawal, Randomness, ShardCommittee, ShardGroupId,
        SlotEffects, Stake, StakePool, StakePoolId, TransitionCause, ValidatorId, ValidatorRecord,
        ValidatorStatus, bls_keypair_from_seed, vrf_output_from_proof, vrf_sign,
    };

    use super::lifecycle::distribute_epoch_rewards;
    use super::*;
    use crate::constants::{
        BEACON_SIGNER_COUNT, JAIL_COOLDOWN_EPOCHS, MIN_STAKE_FLOOR, MISSED_PROPOSAL_JAIL_THRESHOLD,
