...
impl Verified<ProvisionTxRootsMap> {
    ...
    /// transaction a committed outcome promises a crossing bundle to;
    /// after those, in block order, every transaction the block offers a
    /// consumer's crossing again. Each
