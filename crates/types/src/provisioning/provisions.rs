...
impl Provisions {
    ...
    ///
    /// One span for every bundle, a crossing record included: a record
    /// nobody claimed is offered again off a fresh block, and what
    /// carries that offer is the new block's own bundle rather than
    /// this one kept alive.
    #[must_use]
