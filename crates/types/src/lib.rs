...
pub use beacon::{
    ...
    MAX_READY_SIGNALS_PER_BLOCK, MAX_READY_WINDOW_BLOCKS, MAX_SHARDS, MAX_VOTE_VECTOR_LEN,
    ...
    PendingWithdrawal, READY_TIMEOUT_EPOCHS, RESHAPE_TRIGGER_TTL_EPOCHS, ReadySignal,
