...
pub use beacon::{
    ...
    StakePool, TransitionCause, ValidatorRecord, ValidatorStatus, Witness, build_indirect_cert,
    build_qc1, build_qc2, build_qc3, genesis_config_hash, hash_high_value, mce, mcp, qc1_certify,
    sign_empty_view_msg, sign_vote1, sign_vote2, sign_vote3, skip_target, verify_block_cert,
    verify_cert, verify_empty_view_msg, verify_proposal_object, verify_qc1, verify_qc2, verify_qc3,
