...
pub use beacon::{
    ...
    PcVoteMessageVerifyError, PcVoteRound, PcVoteVerifyContext, PcXpProof, PendingWithdrawal,
    ...
    SpcEmptyViewMsg, SpcHighTriple, SpcProposalObject, StakePool, TransitionCause, ValidatorRecord,
    ValidatorStatus, Witness, build_qc1, build_qc2, build_qc3, genesis_config_hash, mce, mcp,
    qc1_certify, sign_vote1, sign_vote2, sign_vote3, verify_qc1, verify_qc2, verify_qc3,
