...
pub use beacon::{
    BeaconBlock, BeaconCert, BeaconGenesisConfig, BeaconProposal, BeaconProposalVerifyContext,
    ...
    CertifiedBeaconBlockVerifyError, CommitteeTransition, GenesisPool, GenesisValidator,
    JailReason, MAX_BEACON_WITNESS_EVENTS_PER_TX, MAX_PREFIX_SIGS, MAX_READY_SIGNALS_PER_BLOCK,
    ...
    ReadySignal, SHARD_WITNESS_LEAF_DOMAIN_TAG, ShardCommittee, ShardWitness, ShardWitnessPayload,
