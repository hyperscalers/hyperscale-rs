...
pub use beacon::{
    ...
    MAX_EQUIVOCATIONS_PER_BLOCK, MAX_EQUIVOCATIONS_PER_PROPOSER, MAX_PREFIX_SIGS,
    ...
    SHUFFLE_SYNC_HEADROOM, SPC_INPUT_DWELL, SPC_VIEW_TIMEOUT, ShardBoundary, ShardCommittee,
