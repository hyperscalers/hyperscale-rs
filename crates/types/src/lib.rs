...
pub use beacon::{
    ...
    ShardWitnessProof, SkipEpochCert, SkipEpochCertVerifyError, SkipReport, SkipRequest,
    ...
    SpcVerifyContext, StakePool, TransitionCause, ValidatorRecord, ValidatorStatus, Witness,
