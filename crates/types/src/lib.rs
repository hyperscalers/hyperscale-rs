...
pub use beacon::{
    ...
    MAX_WITNESSES_PER_PROPOSER, MIN_STAKE_FLOOR, MISSED_PROPOSAL_JAIL_THRESHOLD,
    ...
    TransitionCause, UNBONDING_WINDOW_EPOCHS, ValidatorRecord, ValidatorStatus, Witness,
