...
pub use beacon::{
    ...
    MAX_BEACON_WITNESS_EVENTS_PER_TX, MAX_EQUIVOCATIONS_PER_BLOCK, MAX_EQUIVOCATIONS_PER_PROPOSER,
    ...
    PendingWithdrawal, RESHAPE_HANDOFF_TTL_EPOCHS, RESHAPE_READY_TTL_EPOCHS,
    ...
    SHARD_CAPACITY, SHARD_WITNESS_LEAF_DOMAIN_TAG, SHUFFLE_SYNC_HEADROOM, SPC_INPUT_DWELL,
