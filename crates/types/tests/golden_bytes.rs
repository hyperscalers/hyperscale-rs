...
mod records {
    use hyperscale_types::{
        AbandonmentRecord, AbortCharge, Address, AddressClass, Deadline, LocalKey, RoutePrefix,
        SubstateKey, TxHash, UnsettledTx,
    };
    ...
    const EXPECTED_DEPARTED_RECORD: &str = "";
}
