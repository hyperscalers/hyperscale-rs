...
mod records {
    ...
    use super::{Hash, ShardId, WeightedTimestamp, assert_golden};
    ...
    fn golden_unsettled() -> UnsettledTx {
        UnsettledTx {
            ...
            escrowed: Capped::from_array([SubstateKey {
                owner: Address::new([0x55; 31], AddressClass::Component),
                local: LocalKey([0x66; 16]),
            }]),
        }
    }
    ...
    const EXPECTED_UNSETTLED_TX: &str = "";
    const EXPECTED_DEPARTED_RECORD: &str = "";
}
